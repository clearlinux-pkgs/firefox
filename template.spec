...
Source0  : http://ftp.mozilla.org/pub/mozilla.org/firefox/releases/##VERSION##/linux-x86_64/en-US/firefox-##VERSION##.tar.bz2
Source1  : http://ftp.mozilla.org/pub/mozilla.org/firefox/releases/##VERSION##/source/firefox-##VERSION##.source.tar.xz
